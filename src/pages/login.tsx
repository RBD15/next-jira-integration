...
export const Login = () => {
  ...
  const loginSubmit = async (e: any) => {
    ...
    .then((userCredential) => {
      ...
      context.auth.name = user.displayName
      router.push('/')
    })  
    .catch((error) => {
    ...
    <main className="form-signin w-100 m-auto">
      <form onSubmit={loginSubmit}>
        ...
        <div className="form-floating">
          <input type="email" className="form-control" name="email" id="floatingInput" ref={email} placeholder="name@example.com" />
          <label htmlFor="floatingInput">Email address</label>
        </div>
        <div className="form-floating">
          <input type="password" className="form-control" id="floatingPassword" name="password" ref={password} placeholder="Password"/>
